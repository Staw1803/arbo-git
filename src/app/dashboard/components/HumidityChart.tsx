...
export function HumidityChart({ data }: { data: TelemetryData[] }) {
    ...
    if (!data || !Array.isArray(data)) return <div className="h-[400px] flex items-center justify-center text-zinc-500 font-mono text-sm">Aguardando dados hídricos...</div>
