    ...
    return (
        <Card className="rounded-2xl border border-white/10 bg-black/40 backdrop-blur-md shadow-2xl w-full">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
                <div>
                   <CardTitle className="text-sm font-semibold tracking-wider text-gray-300">EVOLUÇÃO TÉRMICA</CardTitle>
                   <p className="text-xs text-gray-500 mt-1">Variação de Temperatura Ambiente (°C)</p>
                </div>
